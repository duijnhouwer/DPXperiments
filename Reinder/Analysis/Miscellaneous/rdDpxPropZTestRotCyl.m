...
warning(['lummcor is set to: ' num2str(lummcorr)]);
...
stereo=D.(exp.monoCueFog)==0 & D.(exp.monoCueDiam)==0 & D.(exp.lummCor)==lummcorr; % & D.(exp.lummCor)==-1;%for anti-cor %D.(exp.monoCueFog)==0 & D.(exp.monoCueDiam)==0 & D.(exp.lummCor)==1;
